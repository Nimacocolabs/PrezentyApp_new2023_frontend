          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Get access to a new way to earn, save and spend for teens and young adults!',
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      'Do you have a scratch card or coupon code?',
                      style:
                    ...
                    : ElevatedButton(
                        onPressed: () async {
                          try {
                            ...
                            String scratchCode = _textFieldControlScartchCode
                                .value.controller.text;
                            String typedReferralCode =
                            ...
                            if (scratchValidOrNot?.data?.type == "coupon") {
                              ...
                              Get.to(() => ApplyPrepaidCardListScreen(
                                    isUpgrade: false,
                                    isFromSignUp: true,
                                    signupCouponCode: scratchCode,
                                    signupReferralCode: typedReferralCode,
                                  ));
